        ...
        <div className="snap-start flex-shrink-0 w-80 rounded-xl shadow-md overflow-hidden">
            <div className="bg-gray-800 p-5">
                ...
                <div className="flex items-center gap-3 mt-4">
                    ...
                    <button className="px-2 h-6 bg-white text-black text-sm font-semibold rounded-full whitespace-nowrap hover:bg-gray-100 transition">
                        +팔로우
                    </button>
                </div>
            </div>
